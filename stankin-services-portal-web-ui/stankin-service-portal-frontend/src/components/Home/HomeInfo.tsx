...
const HomeInfo = () => {
    return <div>
        <CustomModal
            ...
            icon=
                {(<svg className="mb-4 w-20 h-auto mx-auto" width="72" height="63" viewBox="0 0 72 63" fill="none"
                    ...
                    <path
                        ...
                        className="stroke-gray-800 dark:stroke-gray-200" stroke="currentColor" stroke-width="2"
                    ...
                    <path
                        ...
                        className="fill-gray-800 dark:fill-gray-200" fill="currentColor"
        ...
        <Link to='/auth'
              className="link-to-auth text-2xl text-stankin-gray text-right uppercase flex items-center justify-end gap-2">
            Войти
            <svg className="transition" xmlns="http://www.w3.org/2000/svg" width="40px" height="40px"
